...
description: Wieso noch eine weitere Gehörbildungs-App? Diese ist anders!
---
::
...
- Identifikation von Skalen und Modi linear
- Identifikation von Skalen und Modi in Melodien
...
- Über 50 klassische Kadenzen: Zwischendominanten, plagale Kadenzen, Lagen, Neapolitanischer Sextakkord, Vorhalts-Quartsextakkorde, Pachelbel-Kadenzen, übermässiger Quartsextakkorde, Ellipsen, Lamento-Bewegungen und weitere (siehe :base-link{to="/KlassischeKadenzenET-EarTrainer.pdf"}[hier])
<br><br>
...
:app-video{url="https://www.youtube-nocookie.com/embed/lFo_Ga7APt0"}

:app-video{url="https://www.youtube-nocookie.com/embed/n0LRete1GnY"}

:app-video{url="https://www.youtube-nocookie.com/embed/pEpDcU7YPJk"}

:app-video{url="https://www.youtube-nocookie.com/embed/Y1z09upjZw8"}
...
Die Fähigkeit zur Selbstreflexion spielt beim Hör-Training ebenfalls eine grosse Rolle: Wie weit reicht meine Intuition? Wo sind die Grenzen meines Hörens? Mit welchen Übungen kann ich mein Gehör entwickeln?
::
...
- Der Ton wird nicht genau genug gesungen / gespielt. Falls die Toneingabe auch über ein externes Klavier nicht funktioniert, Option "Easy" einstellen; falls das Problem nicht gelöst ist: Option "Üb-Modus" aktivieren.
- Ruhige Arbeitsumgebung wählen
- Bei Stimmeingabe Option “Toneingabe mit Stimme“ aktivieren
- Position und Winkel zum Smartphone ändern: Je nach Modell existieren verschiedene Mikrofone (unten, oben neben Kameras, hinten, etc.)
::
...
- Position und Winkel zum Smartphone ändern: Je nach Modell existieren verschiedene Mikrofone (unten, oben neben Kameras, hinten, etc.)
- Falls das Mikrofon trotzdem nicht funktioniert: App beenden und neu starten. Falls das Problem immer noch nicht behoben ist: Smartphone neu starten.
::
...
- Button "Genaue Oktaven" im Hauptmenü ausschalten. Hinweis: Die Übungen _Fünftonraum_, _Imitation Diatonisch_, _Resolution Game_ und _Memory_ verwenden die Einstellung "genaue Oktaven".
::
...
- Die Voicings zuerst arpeggiert hören/üben: Option "Easy" einschalten
- _Statistik_ abrufen und beispielsweise nur Voicings in Oktavlage auswählen (nur bei Dreiklängen möglich)
::
...
:::content-button{to="/KlassischeKadenzenET-EarTrainer.pdf" icon="feed"}
Klassische Kadenzen
:::
::
...
MIDI-Eingaben werden unterstützt.
::
...
::content-link{to=https://inf.ethz.ch/de/news-und-veranstaltungen/spotlights/infk-news-channel/2021/07/anniversary-alumni-schenker.html}
Link einem Interview der ETH Zurich
::
